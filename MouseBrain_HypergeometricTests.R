## 2018.02.18
## source("/sonas-hs/mccombie/hpc/home/jlihm/ATAC-seq/paper/Bo_control_common_genes.20170216.R")
...
####### TEST
sig_genes <-  TIS.f10_split_hyp.res3_b$name2[which( TIS.f10_split_hyp.res3_b$yx_p.value_adj<0.05 )]
